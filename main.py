...
from routers import user, challenge, submission, result, category, model, file_upload, translation, tools, reports, template, arena_challenge, template_v2, translate_v2
